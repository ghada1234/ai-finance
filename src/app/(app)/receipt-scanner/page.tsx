    ...
    try {
      ...
      reader.onload = async (e) => {
        ...
        try {
          ...
          console.log('Receipt data extracted successfully:', extractedData);
          ...
          if (!extractedData.merchant || !extractedData.total) {
            alert('Warning: Some data may be missing. Please review the extracted information.');
          }
